...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className=flex min-h-screen flex-col lg:flex-row style={{ backgroundColor: colors.canvas }}>
      {/* Desktop Sidebar (lg+) */}
      <aside className=hidden lg:flex lg:w-64 lg:flex-col lg:border-r lg:p-6 sticky top-0 h-screen style={{ borderColor: colors.line, backgroundColor: colors.surface }}>
        {/* Branding */}
 ...
 href={tab.path}
 className={
 flex items-center gap-3 rounded-xl px-4 py-3 text-[14px] font-semibold no-underline
 ...
 <div className=rounded-xl border p-3 style={{ borderColor: colors.line, backgroundColor: colors.surfaceSubtle }}>
