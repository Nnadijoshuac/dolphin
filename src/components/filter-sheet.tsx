 ...
 * Avoids jarring in-place shifts by giving the user a dedicated, calm
 * canvas to configure both Kind (A2A / MCP) and Categories.
 */
export function FilterSheet({
  ...
  // Local draft state so the user can tweak filters peacefully before committing
